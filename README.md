...
│  │  ├─ magnific-popup.css
│  │  ├─ overlay
│  │  │  ├─ overlay-slide-bottom.css
│  │  │  ├─ overlay-slide-left.css
│  │  │  ├─ overlay-slide-right.css
│  │  │  └─ overlay-slide-top.css
│  │  ├─ owl.carousel.css
│  │  ├─ owl.video.play.png
│  │  ├─ rotate
│  │  │  ├─ rotate-lg.css
...
```](public/apple-touch-icon.png) public/browserconfig.xml ![
```
KimPortfolio
├─ .env
├─ config
...
```](public/favicon.png) public/index.html ![
```
KimPortfolio
├─ .env
├─ config
...
```](public/mstile-150x150.png) public/project-detail.html ![
```
KimPortfolio
├─ .env
├─ config
...
```](public/safari-pinned-tab.svg) public/site.webmanifest routes routes/index.js .env .gitignore package-lock.json package.json project-hierarchy.txt README.md server.js